...
const ITEMS = [
  ...
  { id: "sideproj",label: "SIDE PROJECTS", page: "sideproj",fontSize: 64, offsetX: 22, offsetY: 8,  skew: -6,  skewY: -8  },
  { id: "contact", label: "CONTACT",       page: "contact", fontSize: 60, offsetX: 12, offsetY: 8,  skew: 0,   skewY: 6   },
];
